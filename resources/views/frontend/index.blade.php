          ...
          <div class="row align-items-center">
            <div class="col-lg-6" data-aos="fade-right">
              <div class="hero-content">
                ...
                <p>We create innovative digital solutions that drive growth and elevate your brand.</p>
            ...
            <div class="col-lg-6" data-aos="fade-left">
              <div class="hero-image">
                  <img src="{{asset('frontend/assets/img/misc/misc-16.webp')}}" height="450" width="700" alt="Slide 2">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="carousel-item">
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-lg-6" data-aos="fade-left">
              <div class="hero-image">
                <img src="{{asset('frontend/assets/img/misc/misc-17.webp')}}" height="450" width="700" alt="Slide 2">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="carousel-item">
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-lg-6" data-aos="fade-left">
              <div class="hero-image">
             <img src="{{asset('frontend/assets/img/misc/misc-18.webp')}}" height="450" width="700" alt="Slide 2">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-7" data-aos="fade-left" data-aos-delay="300">
            <div class="image-composition">
              <div class="image-main">
                <img src="{{asset('frontend/assets/img/about/about-9.webp')}}" alt="Modern office with a team working" class="img-fluid" loading="lazy">
              </div>
              <div class="image-secondary">
                <img src="{{asset('frontend/assets/img/about/about-square-8.webp')}}" alt="Collaborative discussion" class="img-fluid" loading="lazy">
              </div>
        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
          ...
          <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="300">
            <div class="col-xl-4 col-lg-6 portfolio-item isotope-item filter-web">
              <div class="portfolio-wrapper">
                <div class="portfolio-image">
                  <img src="{{asset('frontend/assets/img/portfolio/portfolio-7.webp')}}" alt="Creative Web Project" class="img-fluid" loading="lazy">
            ...
            <div class="col-xl-4 col-lg-6 portfolio-item isotope-item filter-mobile">
              <div class="portfolio-wrapper">
                <div class="portfolio-image">
                  <img src="{{asset('frontend/assets/img/portfolio/portfolio-8.webp')}}" alt="Mobile App Project" class="img-fluid" loading="lazy">
                  <div class="portfolio-hover">
                    <div class="portfolio-actions">
            ...
            <div class="col-xl-4 col-lg-6 portfolio-item isotope-item filter-branding">
              <div class="portfolio-wrapper">
                <div class="portfolio-image">
                  <img src="{{asset('frontend/assets/img/portfolio/portfolio-9.webp')}}" alt="Branding Project" class="img-fluid" loading="lazy">
                  <div class="portfolio-hover">
                    <div class="portfolio-actions">
            ...
            <div class="col-xl-4 col-lg-6 portfolio-item isotope-item filter-ui">
              <div class="portfolio-wrapper">
                <div class="portfolio-image">
                  <img src="{{asset('frontend/assets/img/portfolio/portfolio-10.webp')}}" alt="UI/UX Project" class="img-fluid" loading="lazy">
                  <div class="portfolio-hover">
                    <div class="portfolio-actions">
            ...
            <div class="col-xl-4 col-lg-6 portfolio-item isotope-item filter-web">
              <div class="portfolio-wrapper">
                <div class="portfolio-image">
                  <img src="{{asset('frontend/assets/img/portfolio/portfolio-11.webp')}}" alt="E-commerce Platform" class="img-fluid" loading="lazy">
                  <div class="portfolio-hover">
                    <div class="portfolio-actions">
            ...
            <div class="col-xl-4 col-lg-6 portfolio-item isotope-item filter-mobile">
              <div class="portfolio-wrapper">
                <div class="portfolio-image">
                  <img src="{{asset('frontend/assets/img/portfolio/portfolio-12.webp')}}" alt="Fintech Mobile App" class="img-fluid" loading="lazy">
                  <div class="portfolio-hover">
                    <div class="portfolio-actions">
          ...
          <div class="swiper-wrapper">
              ...
              <div class="testimonial-card" data-aos="zoom-in" data-aos-delay="100">
                <div class="testimonial-header">
                  <div class="user-avatar">
                    <img src="{{asset('frontend/assets/img/person/person-f-12.webp')}}" alt="Profile Image">
                  </div>
                  <div class="user-info">
            ...
            <div class="swiper-slide">
              <div class="testimonial-card" data-aos="zoom-in" data-aos-delay="200">
                <div class="testimonial-header">
                  <div class="user-avatar">
                    <img src="{{asset('frontend/assets/img/person/person-m-11.webp')}}" alt="Profile Image">
                  </div>
                  <div class="user-info">
            ...
            <div class="swiper-slide">
              <div class="testimonial-card" data-aos="zoom-in" data-aos-delay="300">
                <div class="testimonial-header">
                  <div class="user-avatar">
                    <img src="{{asset('frontend/assets/img/person/person-f-8.webp')}}" alt="Profile Image">
                  </div>
                  <div class="user-info">
                    <h3>Rachel Taylor</h3>
            ...
            <div class="swiper-slide">
              <div class="testimonial-card" data-aos="zoom-in" data-aos-delay="100">
                <div class="testimonial-header">
                  <div class="user-avatar">
                    <img src="{{asset('frontend/assets/img/person/person-m-14.webp')}}" alt="Profile Image">
                  </div>
                  <div class="user-info">
            ...
            <div class="swiper-slide">
              <div class="testimonial-card" data-aos="zoom-in" data-aos-delay="200">
                <div class="testimonial-header">
                  <div class="user-avatar">
                    <img src="{{asset('frontend/assets/img/person/person-f-5.webp')}}" alt="Profile Image">
                  </div>
                  <div class="user-info">
...
<section id="blog" class="portfolio section">
  ...
  <div class="container section-title" data-aos="fade-up">
    ...
    <h2>Blog</h2>
    <p>
      Welcome to my Blog! Explore articles, tips, and creative ideas about Web Development, UI/UX Design, and Digital Innovation — crafted to inspire your next project.
    </p>
  </div>
  ...
  <div class="container">
   ...
   <!-- ======= Footer ======= -->
  <footer id="footer" class="footer position-relative" style="background-color: #01020E; color: #fff;">
    <div class="container footer-top py-5">
      <div class="row gy-4">

        <div class="col-lg-4 col-md-6 footer-about">
          <a href="index.html" class="logo d-flex align-items-center mb-3 text-decoration-none">
            <span class="sitename fw-bold fs-4" style="color: #6c63ff;">Aman IT Agency</span>
          </a>
          <div class="footer-contact">
            <p>House 10, Road 12</p>
            <p>Uttara, Dhaka, Bangladesh</p>
            <p class="mt-3"><strong>Phone:</strong> <span>+880 1777 000 999</span></p>
            <p><strong>Email:</strong> <span>info@amanitagency.com</span></p>
          </div>
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <form action="#" method="post" class="d-flex mt-3">
            ...
            <button type="submit" class="btn rounded-end" style="background-color: #6c63ff; color: #fff;">Subscribe</button>
          </form>
        </div>
    ...
    <div class="container copyright text-center mt-4">
      ...
      <div class="credits">
        Designed & Developed by <a href="#">&nbsp;&nbsp;Magpie-IT</a>
      </div>
    </div>
  </footer>
  <!-- ======= End Footer ======= -->
